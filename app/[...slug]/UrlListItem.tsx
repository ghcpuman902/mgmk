...
export function getDomainSteps(shortDomain: string, longDomain: string): string[] {
  ...
  export function getPathSteps(shortPath: string, longPath: string): string[] {
  ...
  export function splitAndMatchInitials(shortSec: string, longSec: string): [string, string][] {
  ...
  export function getSectionSteps(shortSection: string, longSection: string): string[] {
  ...
  export function mergeSteps(steps_arrays: (string[] | string)[]): string[] {
...
export default function UrlListItem({ shortDomain, longDomain, shortPath, longPath }: UrlListItemProps) {
    ...
    return (
        ...
        >
            <a
                href={`${shortDomain.startsWith('localhost') ? 'http' : 'https'}://${shortDomain}${shortPath}`}
